        ...
        <div className="bg-white text-center text-gray-800 mt-22 pb-15">
            ...
            <nav className="flex bg-white h-[70px] justify-center text-black items-center">
                <ul className="flex justify-center font-semibold text-gray-700 lg:text-xl md:text-xl md:gap-6 gap-3 lg:gap-6">
                    ...
                    <li onClick={() => setNav("best")} className={`cursor-pointer transition ${nav === "best" ? "text-yellow-500" : "hover:text-yellow-500"}`}>Best Sellers</li>
                    <li onClick={() => setNav("onSale")} className={`cursor-pointer transition ${nav === "onSale" ? "text-yellow-500" : "hover:yellow-gray-500"}`}>On Sales</li>
                    <li onClick={() => setNav("sale")} className={`cursor-pointer transition ${nav === "sale" ? "text-yellow-500" : "hover:text-yellow-500"}`}>Sale Items</li>
                </ul>
            </nav>
