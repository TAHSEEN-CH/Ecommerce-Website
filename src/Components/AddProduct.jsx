...
const AddProduct = () => {
  return (
    <div className="w-[full] min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-300 p-10 overflow-hidden">
      <div className="w-full max-w-[600px] bg-white p-6 rounded-xl shadow-lg">
        <h1 className="text-4xl text-center font-bold text-gray-800 mb-6">Add Product</h1>
