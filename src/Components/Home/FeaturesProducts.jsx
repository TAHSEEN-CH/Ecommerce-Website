...
const product = [
  { id: 1, image: "/Home/product(5).jpg", hoverimage: "/Home/product(6).jpg", title: "New Affordable Fire TV", price: "$38.50", oldprice: "$42.50" },
  { id: 2, image: "/Home/product(7).jpg", hoverimage: "/Home/product(8).jpg", title: "Webcam, Cameras Optics, Output", price: "$38.50",oldprice: "$42.50", priceoff: "10%" },
  { id: 3, image: "/Home/product(2).jpg", hoverimage: "/Home/product(3).jpg", title: "Digital Air Fryer Stainless Steel", price: "$38.50", oldprice: "$48.50", priceoff: "7%" },
  { id: 4, image: "/Home/product(4).jpg", hoverimage: "/Home/product(9).jpg", title: "Bissel SportClean Pro Portable Carpet", price: "$38.50", oldprice: "$44.50" },
  { id: 5, image: "/Home/product(10).jpg", hoverimage: "/Home/product(1).jpg", title: "Alexa-Compatiable Echo Devices ", price: "$38.50",oldprice: "$44.50", priceoff: "5%" },
  { id: 6, image: "/Home/product(11).jpg", hoverimage: "/Home/product(9).jpg", title: "Piano Black Nespresso Vertuo Plus", price: "$38.50",  },
  { id: 7, image: "/Home/product(8).jpg", hoverimage: "/Home/product(7).jpg", title: "Fashion Stainless Steel Smart Watch", price: "$40.50",oldprice: "$42.50", priceoff: "10%" },
  { id: 8, image: "/Home/product(6).jpg", hoverimage: "/Home/product(5).jpg", title: "New Affordable Fire TV", price: "$38.50", },
];
